...
func OnNumberUpdate(arg1, arg2, arg3 uintptr) (ret uintptr) {
	...
	strArg3 = strings.Replace(strArg3, "0", "Íö", -1)
	strArg3 = strings.Replace(strArg3, "1", "ìé", -1)
	strArg3 = strings.Replace(strArg3, "2", "ì£", -1)
	strArg3 = strings.Replace(strArg3, "3", "ß²", -1)
	strArg3 = strings.Replace(strArg3, "4", "ÞÌ", -1)
	strArg3 = strings.Replace(strArg3, "5", "çé", -1)
	strArg3 = strings.Replace(strArg3, "6", "ë»", -1)
	strArg3 = strings.Replace(strArg3, "7", "öÒ", -1)
	strArg3 = strings.Replace(strArg3, "8", "ø¢", -1)
	strArg3 = strings.Replace(strArg3, "9", "Îú", -1)
	// strArg3 = "¾ß¿Ë, ¸Û¸Û, ±Í¿©¿ö! <" + strArg3 + "> by ÄÚÄÚ³Ó xD ³È³È"
